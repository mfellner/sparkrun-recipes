...
- Commit: `f906ee990596486e10ddbe381efa6f0e496f77e3`
...
`verify_upstream_source_parity.py` downloads the exact `f906ee990596486e10ddbe381efa6f0e496f77e3`
...
all pytest-compatible upstream checks pass with **114 passed and 13 subtests passed**;
the upstream standalone APC composition gate then passes against the exact pristine
base-image runtime, and `test_suppress_stops_multitoken.py` runs as an independently executable
