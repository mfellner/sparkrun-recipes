...
CLUSTER = "sparkrun_3d13e8eba3fa512a_38acb2ac0fc5"
EXPECTED_ACCEPTANCE_RUN_ID = "1941bd91758d28de"
...
EXPECTED_ACCEPTANCE_ARGV = [
    "evidence/glm53-exl3-850k-20260909/acceptance.py",
    ...
    "--out", "evidence/glm53-exl3-850k-20260909/acceptance.json",
...
FINAL_ARTIFACT_SHA256 = {
    ...
    "capture_runtime.py": "7f93b2775e92d081a1060695f828a7b4ea1dac673769bd5b442194070fe93488",
    ...
    "acceptance.json": "069b2c6b02f2bb3d7896f568d8cef1677743039baa8c73b4edd7989b2bd8f9f5",
    "runtime.json": "cbf755a61d07bef178cd0e96050bbb9ad5b8961d1b2ea6c2286b1485a1c5777c",
    "load-telemetry.log": "23f87718dcea739ff5422c6ecc7d881c8408a3962f61960baa29483c919f52cd",
    "proxy-models.json": "653e56e87cfd6394416ec1b2dd691200168bb58c9c3aff6452f15c09122d0fff",
    "proxy-start.log": "61e479caa328c4d3040abc6d565d2ee7435deb4675f8213641fb3b1173318fed",
    "launch-epoch.txt": "974b3ed91f355c6edb0779da2773c642024cdfabbc21cd66a2d8c901c9a58eb1",
    "launch-receipt.json": "ad55b5b48f6352f230d77f62b2f5f9bf45b720c9c1142b6245f893f3d610ded4",
    "launch.log": "4f48638e80e2fb4872c88d3ab233558671c4a8a48f803d8b6a91d27299fa0198",
...
def expected_capture_argv(launch_epoch: int, acceptance_run_id: str) -> list[str]:
    return [
        "evidence/glm53-exl3-850k-20260909/capture_runtime.py",
        "--cluster-id", CLUSTER,
        "--launch-epoch", str(launch_epoch),
        "--launch-receipt", "evidence/glm53-exl3-850k-20260909/launch-receipt.json",
        "--acceptance", "evidence/glm53-exl3-850k-20260909/acceptance.json",
        "--acceptance-run-id", acceptance_run_id,
        "--expected-mod-manifest-sha256", EXPECTED_MOD_MANIFEST_SHA256,
        "--out", "evidence/glm53-exl3-850k-20260909/runtime.json",
    ]
...
def main() -> int:
    ...
    fatal_kernel = ("NVRM: Xid", "Out of memory: Killed process", "oom-kill:")
    required_symbols = (
        "exl3_moe",
        "exl3_fat_gemm",
    ...
    for host, row in runtime.get("hosts", {}).items():
        ...
        remote_commands = (
            ...
            "rdma", "memory", "kernel_since_launch", "kernel_after_acceptance",
        )
